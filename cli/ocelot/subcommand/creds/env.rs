...
pub fn subcommand_handler(args: SubOption) {
    ...
    match args.action {
        ResourceAction::Add(args) => {
            ...
            let req = make_client
                ...
                .and_then(move |mut client| {
                    ...
                    env_proto.sub_type = SubCredType::Env.into();
        ...
        ResourceAction::Delete(_args) => {
            println!("There is no grpc endpoint for deleting environment variables")
        }
        ResourceAction::List(_args) => {
            let req = make_client
                ...
                .and_then(move |mut client| {
                    // TODO: This will apparently need to filter for just env
                    client.get_generic_creds(Request::new(()))
                })
                .and_then(|response| {
                    println!("RESPONSE = {:?}", response);
                    Ok(())
