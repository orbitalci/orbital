...
var (
	// inject with -X github.com/level11consulting/orbitalci/client/commandhelper.AdminHost=my.ocelotadmin.com -X github.com/level11consulting/orbitalci/client/commandhelper.AdminPort=443
	AdminHost = "localhost"
	AdminPort = "10000"
)
