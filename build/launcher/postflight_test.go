...
func TestLauncher_postFlight_subscriptions(t *testing.T) {
	...
	returnedSubs := []*pb.ActiveSubscription{
		{
			SubscribedToAcctRepo: "shankj3/ocelot",
		...
		},
		{
			SubscribedToAcctRepo: "shankj3/ocelot",
			SubscribedToVcsType: pb.SubCredType_BITBUCKET,
			SubscribingAcctRepo: "level11consulting/ocytest",
	...
	ocytest := &pb.TaskBuilderEvent{Subscription: &pb.UpstreamTaskData{BuildId: 1023, Alias: "ocytest", ActiveSubscriptionId: 2}, AcctRepo: "level11consulting/ocytest", VcsType: pb.SubCredType_BITBUCKET, Branch: "master", By: pb.SignaledBy_SUBSCRIBED}
