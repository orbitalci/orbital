...
func (f *fakeWerkerTeller) TellWerker(lastCommit string, conf *build_signaler.Signaler, branch string, handler models.VCSHandler, token, acctRepo string, checkData *build.Viable) (err error) {
	f.told += 1
	return nil
}
