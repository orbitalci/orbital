...
func (*PaginatedRepository) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{0}
}
...
func (*PaginatedRepository_RepositoryValues) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{0, 0}
}
...
func (*PaginatedRepository_RepositoryValues_RepositoryLinks) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{0, 0, 0}
}
...
func (*PaginatedRepository_RepositoryValues_Project) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{0, 0, 1}
}
...
func (*PaginatedRepository_RepositoryValues_MainBranch) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{0, 0, 2}
}
...
func (*ChangeSetV1) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{1}
}
...
func (*PaginatedRepoBranches) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{2}
}
func (m *PaginatedRepoBranches) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PaginatedRepoBranches.Unmarshal(m, b)
}
func (m *PaginatedRepoBranches) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PaginatedRepoBranches.Marshal(b, m, deterministic)
}
func (dst *PaginatedRepoBranches) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PaginatedRepoBranches.Merge(dst, src)
}
func (m *PaginatedRepoBranches) XXX_Size() int {
	return xxx_messageInfo_PaginatedRepoBranches.Size(m)
}
func (m *PaginatedRepoBranches) XXX_DiscardUnknown() {
	xxx_messageInfo_PaginatedRepoBranches.DiscardUnknown(m)
}

var xxx_messageInfo_PaginatedRepoBranches proto.InternalMessageInfo
...
func (*Branch) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{3}
}
...
func (*Branch_Target) Descriptor() ([]byte, []int) {
	return fileDescriptor_respositories_7971d71a33ec6e9d, []int{3, 0}
}
func (m *Branch_Target) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_Branch_Target.Unmarshal(m, b)
}
func (m *Branch_Target) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_Branch_Target.Marshal(b, m, deterministic)
}
func (dst *Branch_Target) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Branch_Target.Merge(dst, src)
}
func (m *Branch_Target) XXX_Size() int {
	return xxx_messageInfo_Branch_Target.Size(m)
}
func (m *Branch_Target) XXX_DiscardUnknown() {
	xxx_messageInfo_Branch_Target.DiscardUnknown(m)
}

var xxx_messageInfo_Branch_Target proto.InternalMessageInfo
...
func (m *Branch_Target) GetDate() *timestamp.Timestamp {
	if m != nil {
		return m.Date
	}
	return nil
...
func init() { proto.RegisterFile("respositories.proto", fileDescriptor_respositories_7971d71a33ec6e9d) }

var fileDescriptor_respositories_7971d71a33ec6e9d = []byte{
