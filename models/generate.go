...
//go:generate protoc --go_out=plugins=grpc:pb/ -I=. -I$GOPATH/src -I${GOPATH}/pkg/mod/github.com/grpc-ecosystem/grpc-gateway@v1.8.6/third_party/googleapis/ -I ${GOPATH}/pkg/mod/github.com/grpc-ecosystem/grpc-gateway@v1.8.6 --grpc-gateway_out=logtostderr=true:pb --swagger_out=logtostderr=true:pb guideocelot.proto storage.proto build.proto creds.proto vcshandler.proto werkerserver.proto
