...
func (m *MockVCSHandler) GetChangedFiles(acctRepo, firstHash, lastHash string) ([]string, error) {
	ret := m.ctrl.Call(m, "GetChangedFiles", acctRepo, firstHash, lastHash)
	ret0, _ := ret[0].([]string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockVCSHandlerMockRecorder) GetChangedFiles(acctRepo, firstHash, lastHash interface{}) *gomock.Call {
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetChangedFiles", reflect.TypeOf((*MockVCSHandler)(nil).GetChangedFiles), acctRepo, firstHash, lastHash)
}
