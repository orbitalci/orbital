use futures::future;
use orbital_headers::organization::{Org, PolledRepo, RegisteredRepo};
...
impl orbital_headers::organization::server::OrganizationService for OrbitalApi {
    ...
    fn register_org(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::OrgRegisterRequest>,
    ...
    fn enable_org(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::OrgEnableRequest>,
    ...
    fn disable_org(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::OrgDisableRequest>,
    ...
    fn delete_org(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::OrgDeleteRequest>,
    ...
    fn register_repo(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::RepoRegisterRequest>,
    ...
    fn update_repo_uri(
        &mut self,
        _request: tower_grpc::Request<
            orbital_headers::organization::RegisteredRepoUpdateUriRequest,
        >,
    ...
    fn update_repo_polling_state(
        &mut self,
        _request: tower_grpc::Request<orbital_headers::organization::RepoUpdatePollingStateRequest>,
