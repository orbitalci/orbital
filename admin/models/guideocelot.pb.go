...
type GuideOcelotClient interface {
	...
	BuildRepoAndHash(ctx context.Context, in *AcctRepoAndHash, opts ...grpc.CallOption) (GuideOcelot_BuildRepoAndHashClient, error)
}
...
func (c *guideOcelotClient) BuildRepoAndHash(ctx context.Context, in *AcctRepoAndHash, opts ...grpc.CallOption) (GuideOcelot_BuildRepoAndHashClient, error) {
...
type GuideOcelotServer interface {
	...
	BuildRepoAndHash(*AcctRepoAndHash, GuideOcelot_BuildRepoAndHashServer) error
}
...
var fileDescriptor0 = []byte{
	...
	,
}
