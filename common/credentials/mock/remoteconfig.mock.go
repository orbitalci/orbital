...
import (
	...
	reflect "reflect"
	creds "github.com/shankj3/ocelot/common/credentials"
)
...
func (m *MockStorageCred) GetStorageCreds(typ storage.Dest) (*creds.StorageCreds, error) {
	ret := m.ctrl.Call(m, "GetStorageCreds", typ)
	ret0, _ := ret[0].(*creds.StorageCreds)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetStorageCreds mocks base method
func (m *MockCVRemoteConfig) GetStorageCreds(typ storage.Dest) (*creds.StorageCreds, error) {
	ret := m.ctrl.Call(m, "GetStorageCreds", typ)
	ret0, _ := ret[0].(*creds.StorageCreds)
	ret1, _ := ret[1].(error)
	return ret0, ret1
