...
pub struct AddOption {
    ...
    #[structopt(name = "Exported Apple dev profile", short = "f", long = "file")]
...
pub fn subcommand_handler(args: SubOption) {
    ...
    match args.action {
        ResourceAction::Add(args) => {
            ...
            let req = make_client
                ...
                .and_then(move |mut client| {
                    ...
                    env_proto.sub_type = SubCredType::Devprofile.into();
        ...
        ResourceAction::Delete(_args) => {
            println!("There is no grpc endpoint for deleting Apple developer profile")
        }
        ResourceAction::List(_args) => {
            let req = make_client
                ...
                .and_then(move |mut client| client.get_apple_creds(Request::new(())))
                .and_then(|response| {
                    println!("RESPONSE = {:?}", response);
                    Ok(())
                })
